...
const config = {
  title: 'Carlos Angulo',
  tagline: 'Staff Engineer · Platform Engineering — setting technical direction for Internal Developer Platforms and raising the engineering bar across teams (AWS, Terraform, CI/CD)',
