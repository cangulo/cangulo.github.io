---
slug: vscode-for-documentation
title: Visual Studio Code for Documentation
authors: cangulo
tags: [vscode, markdown, documentation]
---
...
Visual Studio Code is one of the top IDEs, but did you know you can use it for simple documentation? You only need to learn some Markdown basics!
