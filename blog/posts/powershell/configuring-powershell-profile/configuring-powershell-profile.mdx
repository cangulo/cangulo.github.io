...
:::tip Just want my shortcuts?
The PowerShell shortcuts I currently use are listed in [PowerShell Shortcuts](/personal-config/powershell), part of my [personal config](/personal-config). This post is the full walkthrough of how the profile works.
:::
